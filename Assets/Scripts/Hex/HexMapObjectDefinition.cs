...
public sealed class HexMapObjectPlacementRequest
{
    ...
    {
        return definition != null ? definition.GetResolvedDisplayName() : "Missing Map Object";
    }
}
...
public sealed class HexMapObjectDefinition : ScriptableObject
{
    ...
    [Min(0)] public int edgePadding;
    [Min(0)] public int minDistanceFromStart = 1;
    [Min(0)] public int minDistanceFromGoal = 1;
    [Min(0)] public int minDistanceFromReservedTiles = 1;
    ...
    public void Validate()
    {
        ...
        minDistanceFromReservedTiles = Mathf.Max(0, minDistanceFromReservedTiles);
    ...
    public string GetResolvedDisplayName()
    {
        return string.IsNullOrWhiteSpace(displayName) ? "Map Object" : displayName;
    }
...
public readonly struct HexMapObjectPlacement
{
    public HexMapObjectPlacement(
        ...
        string displayName,
        string variantId = "",
        HexMapObjectDefinition definition = null)
    {
    ...
    public HexMapObjectDefinition Definition { get; }
