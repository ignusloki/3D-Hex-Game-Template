...
public sealed class PitstopPlacementSettings
{
    ...
    [Min(0)] public int pitstopsOnTenByTen = 4;
    ...
    {
        return rows * columns <= 25 ? minimumAverageCorridorOffsetOnFiveByFive : minimumAverageCorridorOffsetOnTenByTen;
    }
    ...
    {
        return midBandOnTenByTen;
    }

    public PitstopFloatRange GetLateBand(int rows, int columns)
    {
        return rows * columns <= 25 ? lateBandOnFiveByFive : lateBandOnTenByTen;
    }
